...
@Component({
  selector: 'app-spc-chart-dimension-measurement',
  templateUrl: './spc-chart-dimension-measurement.component.html',
  styleUrls: ['./spc-chart-dimension-measurement.component.css']
})
export class SpcChartDimensionMeasurementComponent extends BaseDetailComponent implements OnInit {
  detail: any;
  ...
  fillSpcChartData(detail) {
    if (this.detail.chartTypeId === ChartType.xBarR) {
      ...
      this.chartConfigXBarR.lcl = this.detail.lcl !== undefined ? Number(this.detail.lcl.toFixed(this.detail.accuracy)) : 0;
      this.chartConfigXBarR.ucl = this.detail.ucl !== undefined ? Number(this.detail.ucl.toFixed(this.detail.accuracy)) : 0;
      this.chartConfigXBarR.pivot = this.detail.average25 !== undefined ? Number(this.detail.average25.toFixed(this.detail.accuracy)) : 0;
      // range x-bar-r
      this.chartConfigRangeXBarR.accuracy = detail.accuracy;
      this.chartConfigRangeXBarR.lcl = this.detail.rangeXBarLclR !== undefined ? Number(this.detail.rangeXBarLclR.toFixed(this.detail.accuracy)) : 0;
      this.chartConfigRangeXBarR.ucl = this.detail.rangeXBarUclR !== undefined ? Number(this.detail.rangeXBarUclR.toFixed(this.detail.accuracy)) : 0;
      this.chartConfigRangeXBarR.pivot = this.detail.rangeBarAverageFor30 !== undefined ? Number(this.detail.rangeBarAverageFor30.toFixed(this.detail.accuracy)) : 0;
