...
@Component({
  selector: 'app-spc-chart-function-variable',
  templateUrl: './spc-chart-function-variable.component.html',
  styleUrls: ['./spc-chart-function-variable.component.css']
})
export class SpcChartFunctionVariableComponent extends BaseDetailComponent implements OnInit {
  detail: any;
