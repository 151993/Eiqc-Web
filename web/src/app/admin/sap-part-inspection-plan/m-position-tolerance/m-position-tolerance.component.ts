...
@Component({
  selector: 'app-m-position-tolerance',
  templateUrl: './m-position-tolerance.component.html',
  styleUrls: ['./m-position-tolerance.component.css']
})
export class MPositionToleranceComponent extends BaseDetailComponent implements OnInit {
  ...
  ngOnInit(): void {
    super.ngOnInit();
    this.mPositionParameterType = TabType.MPositionTolerance;
    this.getDefaultDataType();
    if (this.detail !== undefined) {
      const mPositionToleranceModel = new MPositionToleranceModel(this.detail);
      this.editData(mPositionToleranceModel);
  ...
  editData(mPositionToleranceModel: MPositionToleranceModel) {
    this.onDimensionNumberChange(mPositionToleranceModel.partDimension);
    this.formInput.patchValue({
      parameterManagement: mPositionToleranceModel.parameterManagement,
      dimensionNumber: mPositionToleranceModel.partDimension,
      specLimitAtMMC: mPositionToleranceModel.specLimitAtMMC,
      specLimitAtLMC: mPositionToleranceModel.specLimitAtLMC,
      spec: mPositionToleranceModel.spec,
      uom: mPositionToleranceModel.uom,
      instrumentType: mPositionToleranceModel.instrumentType,
      dataType: mPositionToleranceModel.dataType
    });
