...
export class SupplierTestReport extends BaseModel {
    ...
    @FormInput()
    @DisplayColumn('ActualResult', { type: ColumnType.DynamicTypeRadioButton })
    ...
    @Trim()
    @FormInput()
    @DisplayColumn('DefectType', { type: ColumnType.DynamicType, mappingField: 'defectTypeName' })
    ...
    constructor(supplierTestReport?: SupplierTestReport) {
