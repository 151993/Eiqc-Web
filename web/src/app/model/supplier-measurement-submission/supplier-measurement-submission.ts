...
import { SMSCommentAttachment } from '../sms-comment-attachment/sms-comment-attachment';

export class SupplierMeasurementSubmission extends BaseModel {
    ...
    @DisplayColumn('Supplier', { type: ColumnType.String, mappingField: 'vendorName' })
    supplierName: String;
    ...
    @FormInput()
    @Expand()
    @DisplayColumn('PurchaseOrder', { type: ColumnType.Status, mappingField: 'purchaseOrderNo' }, false)
    purchaseOrder: PurchaseOrder;


    @DisplayColumn('PurchaseOrder', { type: ColumnType.String, mappingField: 'purchaseOrderNo' })
    ...
    @FormInput()
    @DisplayColumn('Inspector', { type: ColumnType.Status, mappingField: 'name' }, false)
    @Expand()
    inspector: User;


    @DisplayColumn('Inspector', { type: ColumnType.String, mappingField: 'name' })
    ...
    smsCommentAttachments: SMSCommentAttachment[];
    @FormInput()
    ...
    constructor(supplierMeasurementSubmission?: SupplierMeasurementSubmission) {
        ...
        if (supplierMeasurementSubmission) {
            ...
            this.smsCommentAttachments = supplierMeasurementSubmission.smsCommentAttachments;
