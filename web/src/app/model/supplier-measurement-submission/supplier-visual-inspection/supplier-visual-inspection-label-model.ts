...
export class SupplierVisualInspectionLabelModel extends BaseModel {
...
isDisabled: boolean;
    ...
    constructor(supplierVisualInspectionModel?: SupplierVisualInspectionLabelModel) {
        ...
        if (supplierVisualInspectionModel) {
            ...
            this.isDisabled =  supplierVisualInspectionModel.isDisabled;
        } else {
